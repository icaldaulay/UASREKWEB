...
<body id="page-top">
    ...
    <?php if (in_groups('admin')) :  ?>
        <div class="container-fluid"><a class="navbar-brand" href="/admin">YOURCAKE!!</a><button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <?php else:?>
            ...
            <div class="collapse navbar-collapse d-lg-flex justify-content-lg-center"id="navcol-1">
                <ul class="nav navbar-nav">
                    <li role="presentation" class="nav-item"><a class="nav-link active d-lg-flex justify-content-lg-start align-items-lg-start" href="beranda">BERANDA</a></li>
                    <li role="presentation" class="nav-item"><a class="nav-link" href="#produk">PRODUCTS</a></li>
                    <li role="presentation" class="nav-item"><a class="nav-link" href="#aboutus">ABOUT US</a></li>
                    <li role="presentation" class="nav-item"><a class="nav-link" href="/home/riwayat">HISTORY</a></li>
                </ul>
