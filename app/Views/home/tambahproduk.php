...
<body>  
  <div class="container">
        <center>
            ...
            <a href="/home/crudproduk"><button class="btn btn-dark">DATA PRODUK</button></a><br /><br />
        </center>
        <form action="/Home/itemssave" method="post">
            <?= csrf_field(); ?>
            <label for="nama_produk">Nama : </label><br />
            <input class="form-control" type="text" name="nama_produk" id="nama_produk" placeholder="NAMA" required autofocus><br />
            <label for="harga">Harga : </label><br />
            <input class="form-control" type="number" name="harga" id="harga" placeholder="Harga produk" required><br />
            <label for="ket">keterangan : </label><br />
            <input class="form-control" type="text" name="ket" id="ket" placeholder="Keterangan" required><br />
            <label for="gambar">gambar </label>
            <input class="form-control" type="text" name="gambar" id="gambar" placeholder="gambar" required><br />
